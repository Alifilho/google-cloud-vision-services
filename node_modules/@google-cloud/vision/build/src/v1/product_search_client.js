...
class ProductSearchClient {
    ...
    initialize() {
        ...
        for (const methodName of productSearchStubMethods) {
            const innerCallPromise = this.productSearchStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listProductSetsStream(request, options) {
        ...
        this.initialize();
        return this._descriptors.page.listProductSets.createStream(this._innerApiCalls.listProductSets, request, callSettings);
    }
    /**
    ...
    listProductsStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this._descriptors.page.listProducts.createStream(this._innerApiCalls.listProducts, request, callSettings);
    }
    /**
    ...
    listReferenceImagesStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this._descriptors.page.listReferenceImages.createStream(this._innerApiCalls.listReferenceImages, request, callSettings);
    }
    /**
    ...
    listProductsInProductSetStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this._descriptors.page.listProductsInProductSet.createStream(this._innerApiCalls.listProductsInProductSet, request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
